...
motion_path1 = "/hhd4/lizhe/dataset/rog_omomo/OMOMO/data/train_diffusion_manip_seq_joints24.p"
motion_path2 = "/hhd4/lizhe/dataset/rog_omomo/OMOMO/data/test_diffusion_manip_seq_joints24.p"
all_motion_data1 = joblib.load(motion_path1)
all_motion_data2 = joblib.load(motion_path2)

# save as individual files
target_dir = "/hhd4/lizhe/stcomp/motion_data/OMOMO_smplx"
